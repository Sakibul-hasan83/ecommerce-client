...
var require_main = __commonJS({
  "node_modules/style-utils/main.js"(exports) {
    ...
    function stylesToCss5(key, value) {
      var _value = void 0;
...
function polyfill(Component7) {
  var prototype = Component7.prototype;
  if (!prototype || !prototype.isReactComponent) {
    throw new Error("Can only polyfill class components");
  }
  if (typeof Component7.getDerivedStateFromProps !== "function" && typeof prototype.getSnapshotBeforeUpdate !== "function") {
    return Component7;
  }
  ...
  if (foundWillMountName !== null || foundWillReceivePropsName !== null || foundWillUpdateName !== null) {
    var componentName = Component7.displayName || Component7.name;
    var newApiName = typeof Component7.getDerivedStateFromProps === "function" ? "getDerivedStateFromProps()" : "getSnapshotBeforeUpdate()";
    throw Error(
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/TweenOne.js
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/util.js
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/Tween.js
var import_extends2 = __toESM(require_extends());
var import_style_utils2 = __toESM(require_main());

// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/easing.js
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/plugins.js
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/plugin/StylePlugin.js
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/ticker.js
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/TweenOneGroup.js
...
var TweenOneGroup = (function(_Component) {
  (0, import_inherits2.default)(TweenOneGroup2, _Component);
  (0, import_createClass2.default)(TweenOneGroup2, null, [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps, $self = _ref.$self;
      var nextState = {
  ...
  function TweenOneGroup2(props) {
    (0, import_classCallCheck2.default)(this, TweenOneGroup2);
    var _this = (0, import_possibleConstructorReturn2.default)(this, (TweenOneGroup2.__proto__ || Object.getPrototypeOf(TweenOneGroup2)).call(this, props));
  ...
  (0, import_createClass2.default)(TweenOneGroup2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
var _initialiseProps3 = function _initialiseProps4() {
  ...
  this.getCoverAnimation = function(child, i, type) {
    ...
    var onChange2 = _this3.onChange.bind(_this3, animate, child.key, type);
    var props = {
      key: child.key,
      animation: animate,
      onChange: onChange2,
...
// node_modules/rc-banner-anim/node_modules/rc-tween-one/es/index.js
...
var ticker2 = ticker_default;
var Tween3 = Tween_default;

// node_modules/rc-banner-anim/es/Arrow.js
var import_extends5 = __toESM(require_extends());
var import_objectWithoutProperties3 = __toESM(require_objectWithoutProperties());
...
var Arrow = (function(_Component) {
  (0, import_inherits3.default)(Arrow2, _Component);
  function Arrow2() {
    var _ref;
    var _temp, _this, _ret;
    (0, import_classCallCheck3.default)(this, Arrow2);
    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    return _ret = (_temp = (_this = (0, import_possibleConstructorReturn3.default)(this, (_ref = Arrow2.__proto__ || Object.getPrototypeOf(Arrow2)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function(e) {
      if (e.stopPropagation) {
        e.stopPropagation();
      }
      _this.props[_this.props.arrowType](e);
    }, _temp), (0, import_possibleConstructorReturn3.default)(_this, _ret);
  }
  (0, import_createClass3.default)(Arrow2, [{
    key: "render",
    value: function render() {
      var _props = this.props, arrowType = _props.arrowType, next = _props.next, prev = _props.prev, component = _props.component, componentProps = _props.componentProps, defaultBool = _props.defaultBool, prefixCls = _props.prefixCls, children = _props.children, props = (0, import_objectWithoutProperties3.default)(_props, ["arrowType", "next", "prev", "component", "componentProps", "defaultBool", "prefixCls", "children"]);
      ...
      var $props = (0, import_extends5.default)({}, props, componentProps, {
        className,
        onClick: this.onClick
      });
      return import_react4.default.createElement(component, $props, children);
    }
  }]);
  return Arrow2;
...
Arrow.propTypes = {
  ...
  arrowType: import_prop_types3.default.string,
  defaultBool: import_prop_types3.default.bool,
  next: import_prop_types3.default.func,
  prev: import_prop_types3.default.func,
  componentProps: import_prop_types3.default.object
};
Arrow.defaultProps = {
  component: "div",
...
function toArrayChildren2(children) {
  var ret = [];
  import_react5.default.Children.forEach(children, function(c) {
    ret.push(c);
  });
  return ret;
}
function dataToArray2(vars) {
  if (!vars && vars !== 0) {
    return [];
  }
  if (Array.isArray(vars)) {
...
function setAnimCompToTagComp(item, i) {
  ...
  return import_react5.default.createElement(itemProps.component, props, itemProps.children);
}
setAnimCompToTagComp.propTypes = {
  key: import_prop_types4.default.string
};
...
function switchChildren(hideProps, item) {
  ...
  if (item.type.isTweenOne) {
    return import_react5.default.cloneElement(item, { reverse: true });
  }
  return import_react5.default.cloneElement(item, item.props, null);
}

// node_modules/rc-banner-anim/es/Thumb.js
var Thumb = (function(_Component) {
  (0, import_inherits4.default)(Thumb2, _Component);
  function Thumb2() {
    var _ref;
    var _temp, _this, _ret;
    (0, import_classCallCheck4.default)(this, Thumb2);
    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    return _ret = (_temp = (_this = (0, import_possibleConstructorReturn4.default)(this, (_ref = Thumb2.__proto__ || Object.getPrototypeOf(Thumb2)).call.apply(_ref, [this].concat(args))), _this), _this.getDefaultThumb = function() {
      var children = [];
      for (var i = 0; i < _this.props.length; i++) {
        children.push(import_react6.default.createElement("span", { key: i }));
      }
      return children;
    }, _temp), (0, import_possibleConstructorReturn4.default)(_this, _ret);
  }
  (0, import_createClass4.default)(Thumb2, [{
    key: "render",
    value: function render() {
      var _props = this.props, length = _props.length, thumbClick2 = _props.thumbClick, active = _props.active, defaultBool = _props.defaultBool, component = _props.component, componentProps = _props.componentProps, prefixCls = _props.prefixCls, propsChildren = _props.children, props = (0, import_objectWithoutProperties4.default)(_props, ["length", "thumbClick", "active", "defaultBool", "component", "componentProps", "prefixCls", "children"]);
      var className = "banner-anim-thumb";
      var defaultClass = className + "-default";
      className = (className + " " + (prefixCls || "")).trim();
      className = !defaultBool ? className : (className + " " + defaultClass).trim();
      var children = defaultBool ? this.getDefaultThumb() : propsChildren;
      if (length && toArrayChildren2(children).length !== length) {
        console.warn("The thumbnail length and the images length different.");
      }
      var childToRender = toArrayChildren2(children).map(function(item, i) {
        var itemProps = (0, import_extends6.default)({}, item.props);
        ...
        return import_react6.default.cloneElement(item, itemProps);
      });
      var $props = (0, import_extends6.default)({}, props, componentProps, { className });
      return import_react6.default.createElement(component, $props, childToRender);
    }
  }]);
  return Thumb2;
...
Thumb.propTypes = {
  ...
  thumbClick: import_prop_types5.default.func,
  defaultBool: import_prop_types5.default.bool,
  length: import_prop_types5.default.number,
  active: import_prop_types5.default.number,
...
var anim_default = {
  across: function across(elem, type, direction, animData, elemOffset, leaveChildHide) {
    var _x = void 0;
    var props = (0, import_extends7.default)({}, elem.props);
    var children = props.children;
    if (type === "enter") {
      _x = direction === "next" ? "100%" : "-100%";
    } else {
      _x = direction === "next" ? "-100%" : "100%";
      children = toArrayChildren2(children).map(switchChildren.bind(this, leaveChildHide));
    }
    return (0, import_react7.cloneElement)(elem, {
      animation: (0, import_extends7.default)({}, animData, {
        x: _x,
  ...
  vertical: function vertical(elem, type, direction, animData, elemOffset, leaveChildHide) {
    ...
    return (0, import_react7.cloneElement)(elem, (0, import_extends7.default)({}, props, {
      animation: (0, import_extends7.default)({}, animData, {
        y: _y,
        type: type === "enter" ? "from" : "to"
      })
  ...
  gridBar: function gridBar(elem, type, direction, animData, elemOffset, leaveChildHide, ratio, paused) {
    ...
    for (var i = 0; i < gridNum; i++) {
      var style = (0, import_extends7.default)({}, props.style);
      style.width = girdSize + 0.1 + "%";
      style.left = i * girdSize + "%";
      style.position = "absolute";
      style.overflow = "hidden";
      var _style = (0, import_extends7.default)({}, props.style);
      ...
      var animProps = (0, import_extends7.default)({}, props);
      animProps.style = _style;
      var delay = (direction === "next" ? i : gridNum - i) * 50 + (type === "enter" ? 0 : 50) + (animData.delay || 0);
      animProps.animation = (0, import_extends7.default)({}, animData, {
        y: _y,
        type: type === "enter" ? "from" : "to",
        key: type,
        direction,
      ...
      var mask = import_react7.default.createElement(
        "div",
        { style, key: i },
        (0, import_react7.cloneElement)(elem, animProps, children)
      );
      animChild.push(mask);
    }
    var animSlot = import_react7.default.createElement(
      "div",
      { style: { width: "100%", position: "absolute", top: 0 } },
      animChild
    );
    var _props = (0, import_extends7.default)({}, elem.props);
    _props.children = animSlot;
    return (0, import_react7.cloneElement)(elem, (0, import_extends7.default)({}, _props, { animation: { x: 0, y: 0, type: "set" } }));
  },
  grid: function grid(elem, type, direction, animData, elemOffset, leaveChildHide, ratio, paused) {
    ...
    if (type === "leave") {
      props.animation = (0, import_extends7.default)({}, animData, {
        duration: _delay + animData.duration
      });
      props.moment = ((animData.delay || 0) + _delay + animData.duration) * ratio || 0;
      props.paused = paused;
      return import_react7.default.cloneElement(elem, props);
    }
    ...
    for (var i = 0; i < gridNum * gridNumH; i++) {
      ...
      var animation = (0, import_extends7.default)({}, animData, {
        opacity: 1,
        delay,
      ...
      var mask = import_react7.default.createElement(
        ...
        (0, import_react7.cloneElement)(elem, props)
      );
      animChild.push(mask);
    }
    var _props = (0, import_extends7.default)({}, elem.props);
...
var BannerAnim = (function(_Component) {
  (0, import_inherits5.default)(BannerAnim2, _Component);
  (0, import_createClass5.default)(BannerAnim2, null, [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps, $self = _ref.$self;
      var nextState = {
  ...
  function BannerAnim2(props) {
    (0, import_classCallCheck5.default)(this, BannerAnim2);
    var _this = (0, import_possibleConstructorReturn5.default)(this, (BannerAnim2.__proto__ || Object.getPrototypeOf(BannerAnim2)).call(this, props));
    _this.onMouseEnter = function(e) {
      _this.props.onMouseEnter(e);
      if (_this.props.autoPlay && _this.props.autoPlayEffect) {
        ticker2.clear(_this.autoPlayId);
        _this.autoPlayId = -1;
      }
    };
    ...
    _this.onTouchStart = function(e) {
      ...
      _this.mouseStartXY = {
        startX: e.touches === void 0 ? e.clientX : e.touches[0].clientX,
        startY: e.touches === void 0 ? e.clientY : e.touches[0].clientY
      };
    };
    _this.onTouchMove = function(e) {
      ...
      var _this$getDiffer = _this.getDiffer(e, e.touches), differ = _this$getDiffer.differ, rectName = _this$getDiffer.rectName;
      if (!differ) {
        return;
      }
      ...
      if ((_this.animType === anim_default.gridBar || _this.animType === anim_default.grid) && e.touches) {
        return;
      }
      _this.ratio = ratio;
      if (_this.ratio) {
    ...
    _this.onTouchEnd = function(e) {
      ...
      var _this$getDiffer2 = _this.getDiffer(e, e.changedTouches), differ = _this$getDiffer2.differ, rectName = _this$getDiffer2.rectName;
      ...
      if ((_this.animType === anim_default.gridBar || _this.animType === anim_default.grid) && e.changedTouches) {
        var currentShow = _this.currentShow;
    ...
    _this.getDiffer = function(e, touches) {
      var currentX = touches === void 0 ? e.clientX : touches[0].clientX;
      var currentY = touches === void 0 ? e.clientY : touches[0].clientY;
    ...
    _this.getRenderChildren = function(children) {
      ...
      var elementKeyNum = 0;
      var thumbKeyNum = 0;
      toArrayChildren2(children).forEach(function(item, i) {
        if (!item) {
          return;
        }
        var itemProps = (0, import_extends8.default)({}, item.props);
        if (item.type.isBannerAnimElement) {
          ...
          elem.push(import_react8.default.cloneElement(item, itemProps));
          ...
          arrow.push(import_react8.default.cloneElement(item, itemProps));
          ...
          thumb = import_react8.default.cloneElement(item, itemProps);
        }
      });
      if (elem.length > 1) {
        if (!arrow.length && _this.props.arrow) {
          arrow.push(import_react8.default.createElement(Arrow_default, { arrowType: "prev", key: "arrowPrev", next: _this.next, prev: _this.prev, defaultBool: true }), import_react8.default.createElement(Arrow_default, { arrowType: "next", key: "arrowNext", next: _this.next, prev: _this.prev, defaultBool: true }));
        }
        if (!thumb && _this.props.thumb) {
          thumb = import_react8.default.createElement(Thumb_default, {
            length: elem.length,
            key: "thumb",
    ...
    _this.getDomDataSetToState = function() {
      _this.dom = import_react_dom2.default.findDOMNode(_this);
    ...
    _this.getAnimType = function(type) {
      var typeArray = type ? dataToArray2(type) : Object.keys(anim_default);
      var random = Math.round(Math.random() * (typeArray.length - 1));
      return anim_default[typeArray[random]];
    };
    _this.autoPlay = function() {
      if (!_this.mouseStartXY) {
        ticker2.clear(_this.autoPlayId);
        _this.autoPlayId = ticker2.interval(_this.next, _this.props.autoPlaySpeed);
      }
    };
  ...
  (0, import_createClass5.default)(BannerAnim2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    key: "render",
    value: function render() {
      var _props = this.props, type = _props.type, prefixCls = _props.prefixCls, component = _props.component, initShow = _props.initShow, duration = _props.duration, delay = _props.delay, ease = _props.ease, arrow = _props.arrow, thumb = _props.thumb, autoPlaySpeed = _props.autoPlaySpeed, autoPlay = _props.autoPlay, sync = _props.sync, dragPlay = _props.dragPlay, autoPlayEffect = _props.autoPlayEffect, props = (0, import_objectWithoutProperties5.default)(_props, ["type", "prefixCls", "component", "initShow", "duration", "delay", "ease", "arrow", "thumb", "autoPlaySpeed", "autoPlay", "sync", "dragPlay", "autoPlayEffect"]);
      var childrenToRender = this.getRenderChildren(props.children);
      props.className = (props.className + " " + (prefixCls || "")).trim();
      props.style = (0, import_extends8.default)({}, props.style);
      ...
      return import_react8.default.createElement(this.props.component, props, childrenToRender);
    }
  }]);
  return BannerAnim2;
...
BannerAnim.propTypes = {
  ...
  thumb: import_prop_types6.default.bool,
  initShow: import_prop_types6.default.number,
  type: import_prop_types6.default.any,
  duration: import_prop_types6.default.number,
  delay: import_prop_types6.default.number,
  ease: import_prop_types6.default.string,
  autoPlay: import_prop_types6.default.bool,
  autoPlaySpeed: import_prop_types6.default.number,
  autoPlayEffect: import_prop_types6.default.bool,
  onChange: import_prop_types6.default.func,
  onMouseEnter: import_prop_types6.default.func,
  onMouseLeave: import_prop_types6.default.func,
  sync: import_prop_types6.default.bool,
  dragPlay: import_prop_types6.default.bool
};
...
var BannerAnim_default = BannerAnim;

// node_modules/rc-banner-anim/es/Element.js
var import_extends10 = __toESM(require_extends());
var import_objectWithoutProperties7 = __toESM(require_objectWithoutProperties());
...
var import_tween_functions2 = __toESM(require_tween_functions());
...
var BgElement = (function(_React$Component) {
  (0, import_inherits6.default)(BgElement2, _React$Component);
  (0, import_createClass6.default)(BgElement2, null, [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps, $self = _ref.$self;
      var nextState = {
  ...
  function BgElement2(props) {
    (0, import_classCallCheck6.default)(this, BgElement2);
    var _this = (0, import_possibleConstructorReturn6.default)(this, (BgElement2.__proto__ || Object.getPrototypeOf(BgElement2)).call(this, props));
    ...
    _this.onResize = function() {
      ...
      Object.keys(videoRect).forEach(function(key) {
        _this.video.style[key] = (0, import_style_utils3.stylesToCss)(key, videoRect[key]);
      });
    };
    ...
    _this.isVideo = toArrayChildren2(props.children).some(function(item) {
      return item.type === "video";
    });
    if (_this.isVideo) {
      delete anim_default.grid;
      delete anim_default.gridBar;
    }
  ...
  (0, import_createClass6.default)(BgElement2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.dom = import_react_dom3.default.findDOMNode(this);
      if (!this.videoLoad) {
      ...
      if (this.props.scrollParallax) {
        this.tween = new Tween3(this.dom, [(0, import_extends9.default)({
          ease: "linear"
    ...
    value: function render() {
      var _this2 = this;
      var _props = this.props, videoResize = _props.videoResize, scrollParallax = _props.scrollParallax, show = _props.show, component = _props.component, componentProps = _props.componentProps, props = (0, import_objectWithoutProperties6.default)(_props, ["videoResize", "scrollParallax", "show", "component", "componentProps"]);
      if (this.isVideo && videoResize) {
        var children = toArrayChildren2(props.children).map(function(item, i) {
          return import_react9.default.cloneElement(item, (0, import_extends9.default)({}, item.props, {
      ...
      return import_react9.default.createElement(this.props.component, (0, import_extends9.default)({}, props, componentProps));
    }
  }]);
  return BgElement2;
})(import_react9.default.Component);
var BgElement_default = BgElement;
BgElement.propTypes = {
  ...
  videoResize: import_prop_types7.default.bool,
  scrollParallax: import_prop_types7.default.object,
  show: import_prop_types7.default.bool,
  componentProps: import_prop_types7.default.object
};
...
var Element = (function(_Component) {
  (0, import_inherits7.default)(Element2, _Component);
  (0, import_createClass7.default)(Element2, null, [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps, $self = _ref.$self, show = _ref.show, mouseMoveType = _ref.mouseMoveType;
      var nextState = {
        prevProps: props
      };
      if (prevProps && props !== prevProps) {
        if ($self.tickerId !== -1) {
          ticker2.clear($self.tickerId);
          $self.tickerId = -1;
        }
  ...
  function Element2(props) {
    (0, import_classCallCheck7.default)(this, Element2);
    var _this = (0, import_possibleConstructorReturn7.default)(this, (Element2.__proto__ || Object.getPrototypeOf(Element2)).call(this, props));
    ...
    _this.transform = (0, import_style_utils4.checkStyleName)("transform");
    return _this;
  }
  (0, import_createClass7.default)(Element2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.dom = import_react_dom4.default.findDOMNode(this);
    }
  }, {
    key: "componentDidUpdate",
    value: function componentDidUpdate() {
    ...
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      ticker2.clear(this.timeoutID);
      ticker2.clear(this.delayTimeout);
      this.delayTimeout = -1;
      this.timeoutID = -1;
    }
  }, {
    key: "render",
    value: function render() {
      var _props = this.props, prefixCls = _props.prefixCls, callBack = _props.callBack, propsAnimType = _props.animType, duration = _props.duration, delay = _props.delay, ease = _props.ease, elemOffset = _props.elemOffset, followParallax = _props.followParallax, show = _props.show, type = _props.type, direction = _props.direction, leaveChildHide = _props.leaveChildHide, sync = _props.sync, ratio = _props.ratio, mouseMoveType = _props.mouseMoveType, children = _props.children, propsStyle = _props.style, componentProps = _props.componentProps, props = (0, import_objectWithoutProperties7.default)(_props, ["prefixCls", "callBack", "animType", "duration", "delay", "ease", "elemOffset", "followParallax", "show", "type", "direction", "leaveChildHide", "sync", "ratio", "mouseMoveType", "children", "style", "componentProps"]);
      var _state = this.state, currentShow = _state.show, currentMouseMoveType = _state.mouseMoveType;
      var style = (0, import_extends10.default)({}, propsStyle);
      ...
      var bgElem = toArrayChildren2(children).filter(function(item) {
        return item && item.type.isBannerAnimBgElement;
      }).map(function(item) {
        return import_react10.default.cloneElement(item, { show: props.show });
      });
      if (currentShow === show && !currentMouseMoveType || currentMouseMoveType === "reChild") {
        ...
        if (!show) {
          ...
          return import_react10.default.createElement(es_default, props, bgElem);
        }
        if (followParallax) {
          props.onMouseMove = this.getFollowMouseMove();
        }
        return import_react10.default.createElement(es_default, props, mouseMoveType === "update" ? bgElem : this.getChildren());
      }
      var $props = (0, import_extends10.default)({}, props, componentProps);
...
var _initialiseProps5 = function _initialiseProps6() {
  ...
  this.setTicker = function(followParallax, mouseXY) {
    var callback = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : noop4;
    ticker2.clear(_this2.tickerId);
    _this2.tickerId = "bannerElementTicker" + (Date.now() + Math.random());
    var startFrame = ticker2.frame;
    var startX = _this2.enterMouse.x;
    var startY = _this2.enterMouse.y;
    var duration = followParallax.duration || 450;
    var easeFunc = import_tween_functions2.default[followParallax.ease || "easeOutQuad"];
    var start = typeof followParallax.minMove === "number" ? followParallax.minMove : 0.08;
    ticker2.wake(_this2.tickerId, function() {
      var moment = (ticker2.frame - startFrame) * ticker2.perFrame;
  ...
  this.getFollowMouseMove = function() {
    ...
    if (_this2.followParallax) {
      if (_this2.followParallax.delay) {
        ...
        _this2.delayTimeout = _this2.delayTimeout || ticker2.timeout(function() {
          _this2.setState({
  ...
  this.getFollowStyle = function(data, domWH) {
    var style = {};
    dataToArray2(data.type).forEach(function(type) {
      ...
      var _type = (0, import_style_utils4.getGsapType)(type);
      var cssName = (0, import_style_utils4.isConvert)(_type);
      if (cssName === "transform") {
        var transform = (0, import_style_utils4.checkStyleName)("transform");
        style[transform] = style[transform] || {};
        style[transform][_type] = (0, import_style_utils4.stylesToCss)(_type, d).trim();
      } else if (cssName === "filter") {
        var filter = (0, import_style_utils4.checkStyleName)("filter");
        style[filter] = style[filter] || {};
        style[filter][_type] = (0, import_style_utils4.stylesToCss)(_type, d).trim();
      } else {
        style[cssName] = (0, import_style_utils4.stylesToCss)(_type, d).trim();
      }
    });
    return style;
  };
  ...
  this.getChildren = function() {
    return toArrayChildren2(_this2.props.children).map(function(item, i) {
      if (item && item.type === BgElement_default) {
        return import_react10.default.cloneElement(item, { show: _this2.state.show });
      }
  ...
  this.animChildren = function(props, style, bgElem) {
    var _props2 = _this2.props, elemOffset = _props2.elemOffset, leaveChildHide = _props2.leaveChildHide, ratio = _props2.ratio, currentAnimType = _props2.animType, direction = _props2.direction, mouseMoveType = _props2.mouseMoveType, ease = _props2.ease, duration = _props2.duration, delay = _props2.delay, show = _props2.show, sync = _props2.sync, component = _props2.component;
    if (_this2.tickerId) {
      ticker2.clear(_this2.tickerId);
    }
    if (_this2.delayTimeout) {
      ticker2.clear(_this2.delayTimeout);
    ...
    _this2.useTagComp = (currentAnimType === anim_default.gridBar || currentAnimType === anim_default.grid) && (show === _this2.state.show || _this2.state.show && !show);
    props.children = !sync && (show && show !== _this2.state.show || !show && !_this2.state.show) ? bgElem : _this2.getChildren();
    var childrenToRender = import_react10.default.createElement(es_default, props);
    ...
    var tagProps = (0, import_objectWithoutProperties7.default)(tag.props, []);
    ...
    return import_react10.default.cloneElement(tag, tagProps);
  };
};
Element.propTypes = {
  ...
  elemOffset: import_prop_types8.default.object,
  type: import_prop_types8.default.string,
  animType: import_prop_types8.default.func,
  ease: import_prop_types8.default.string,
  ...
  callBack: import_prop_types8.default.func,
  followParallax: import_prop_types8.default.any,
  show: import_prop_types8.default.bool,
  leaveChildHide: import_prop_types8.default.bool,
  sync: import_prop_types8.default.bool,
  ratio: import_prop_types8.default.number,
  mouseMoveType: import_prop_types8.default.string,
  componentProps: import_prop_types8.default.object
};
...
Element.BgElement = polyfill(BgElement_default);
Element.isBannerAnimElement = true;
var Element_default = polyfill(Element);

// node_modules/rc-banner-anim/es/index.js
BannerAnim_default.Arrow = Arrow_default;
BannerAnim_default.Element = Element_default;
BannerAnim_default.Thumb = Thumb_default;
BannerAnim_default.animType = anim_default;
BannerAnim_default.setAnimCompToTagComp = setAnimCompToTagComp;
BannerAnim_default.switchChildren = switchChildren;
var es_default2 = polyfill(BannerAnim_default);
export {
  Arrow_default as Arrow,
  Element_default as Element,
  Thumb_default as Thumb,
  anim_default as animType,
